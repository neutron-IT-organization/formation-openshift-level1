  ...
  formationSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'Présentation_de_Kubernetes_et_Openshift/Exercice_guidé_Exploration_de_la_console',
        {
          ...
          items: [
            'Présentation_de_Kubernetes_et_Openshift/Interface_et_ligne_de_commande/Intéragir_avec_la_ligne_de_commande',
            'Présentation_de_Kubernetes_et_Openshift/Interface_et_ligne_de_commande/Exerice_guidé_Intéragir_avec_la_ligne_de_commande',
            'Présentation_de_Kubernetes_et_Openshift/Interface_et_ligne_de_commande/Examen_des_ressources_Kubernetes',
            'Présentation_de_Kubernetes_et_Openshift/Interface_et_ligne_de_commande/Exercice_guidé_Examen_des_ressources_Kubernetes',
            'Présentation_de_Kubernetes_et_Openshift/Interface_et_ligne_de_commande/Résumé',
          ],
        },
    ...
    },
    {
      ...
      items: [
        ...
        'Gestion_et_administration_du_cluster/Exercice_machineconfig_ca_certificate',
  ...
  exercicesSidebar: [
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'Gestion_et_administration_du_cluster/Exercice_machineconfig_ca_certificate',
          label: 'Exercice 14 — Certificat CA via MachineConfig',
        },
      ],
    },
  ],
